...
# 6. Check if has rvc directory ($TCHT\Retrieval-based-Voice-Conversion-WebUI) (Default C:\TCHT\Retrieval-based-Voice-Conversion-WebUI)
# 7. Download required files/models:
# - Install 7zip
# - Download file
# - Extract file
